var mousePos,phase,scene,camera,renderer,boxSize,geometry,materialGreen,pitchSegments,elevationSegments,particles,side,radius,parentContainer;
...
function draw(){
    ...
    materialGreen = new THREE.MeshBasicMaterial({transparent: true,  color: 0xd1155c,  opacity: 0.4,  side: THREE.DoubleSide});

    pitchSegments = 60;
    elevationSegments = pitchSegments/2;
    particles = pitchSegments*elevationSegments
    side = Math.pow(particles, 1/3);
